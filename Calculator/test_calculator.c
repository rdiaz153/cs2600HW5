...
void test_multiply_positive_numbers(void) {
    TEST_ASSERT_EQUAL(28, multiply(7, 4)); // Expecting 7 * 4 = 28
}

void test_multiply_positive_and_negative_numbers(void) {
    TEST_ASSERT_EQUAL(-12, multiply(4, -3)); // Expecting 4 * -3 = -12
}

void test_multiply_negative_numbers(void) {
    TEST_ASSERT_EQUAL(25, multiply(-5, -5)); // Expecting -5 * -5 = 25
}

void test_multiply_zero(void) {
    TEST_ASSERT_EQUAL(0, multiply(10, 0)); // Expecting 10 * 0 = 0
